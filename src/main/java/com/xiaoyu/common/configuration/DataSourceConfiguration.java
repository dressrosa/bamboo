 ...
 */
@Configuration
@MapperScan("com.xiaoyu.modules.biz.**.dao")
public class DataSourceConfiguration {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		// 设置mapper映射路径
		factory.setMapperLocations(resolver.getResources("classpath*:mappers/modules/biz/**/*Dao.xml"));//
		factory.setConfigLocation(new ClassPathResource("mybatis-config.xml"));// 获取mybatis.xml
		// 设置别名包
		factory.setTypeAliasesPackage("com.xiaoyu");
